...
// Default frequency plan for US 915MHz - Refer to LoraWAN Specification V1.0 section 7.2.2
...
static inline bit_t validDR  (dr_t dr) { return (_DR2RPS_CRC[dr+1]!=ILLEGAL_RPS); } // in range - really ought to range check dr here, but can't because compiler doesn't know sizeof(_DR2RPS_CRC)
